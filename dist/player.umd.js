    ...
    _createClass(Controller, [{
      ...
      value: function initEvent() {
        ...
        this.on('play', function () {
          var _context23;
          _this3.videoPlayBtn.className = _concatInstanceProperty(_context23 = "".concat(icon['iconfont'], " ")).call(_context23, icon['icon-zanting']);
        });
        this.on('pause', function () {
          var _context24;
          _this3.videoPlayBtn.className = _concatInstanceProperty(_context24 = "".concat(icon['iconfont'], " ")).call(_context24, icon['icon-bofang']);
        });
        this.on('loadedmetadata', function (summary) {
