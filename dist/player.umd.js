  ...
  var Controller = /*#__PURE__*/function (_BaseEvent) {
    ...
    _createClass(Controller, [{
      ...
      value: function init() {
        ...
        this._template = _concatInstanceProperty(_context = _concatInstanceProperty(_context2 = _concatInstanceProperty(_context3 = _concatInstanceProperty(_context4 = _concatInstanceProperty(_context5 = _concatInstanceProperty(_context6 = _concatInstanceProperty(_context7 = _concatInstanceProperty(_context8 = _concatInstanceProperty(_context9 = _concatInstanceProperty(_context10 = _concatInstanceProperty(_context11 = _concatInstanceProperty(_context12 = _concatInstanceProperty(_context13 = _concatInstanceProperty(_context14 = _concatInstanceProperty(_context15 = _concatInstanceProperty(_context16 = "\n      <div class=\"".concat(styles['video-play'], "\">\n        <div class=\"")).call(_context16, styles['video-subplay'], "\">\n            <div class=\"")).call(_context15, styles['video-start-pause'], "\">\n              <i class=\"")).call(_context14, icon['iconfont'], " ")).call(_context13, icon['icon-bofang'], "\"></i>\n            </div>\n            <div class=\"")).call(_context12, styles['video-duration'], "\">\n              <span class=\"")).call(_context11, styles['video-duration-completed'], "\">00:00</span>&nbsp;/&nbsp;<span class=\"")).call(_context10, styles['video-duration-all'], "\">00:00</span>\n            </div>\n        </div>\n        <div class=\"")).call(_context9, styles['video-settings'], "\">\n          <div class=\"")).call(_context8, styles['video-resolvepower'], "\">\n            \u5206\u8FA8\u7387\n          </div>\n          <div class=\"")).call(_context7, styles['video-playrate'], " aria-label=\"\u500D\u901F\">\n            \u500D\u901F\n          </div>\n          <div class=\"")).call(_context6, styles['video-volume'], "\" aria-label=\"\u97F3\u91CF\">\n            ")).call(_context5, volumeSVG, "\n          </div>\n          <div class=\"")).call(_context4, styles['video-subsettings'], "\" aria-label=\"\u8BBE\u7F6E\">\n            ")).call(_context3, settingSVG, "\n          </div>\n          <div class=\"")).call(_context2, styles['video-fullscreen'], "\" aria-label=\"\u5168\u5C4F\">\n            ")).call(_context, fullScreenSVG, "\n          </div>\n        </div>\n      </div>\n    ");
      }
    }, {
      ...
      value: function initEvent() {
        ...
        this.on('play', function () {
          var _context17;
          _this3.videoPlayBtn.className = _concatInstanceProperty(_context17 = "".concat(icon['iconfont'], " ")).call(_context17, icon['icon-zanting']);
        });
        this.on('pause', function () {
          var _context18;
          _this3.videoPlayBtn.className = _concatInstanceProperty(_context18 = "".concat(icon['iconfont'], " ")).call(_context18, icon['icon-bofang']);
        });
        this.on('loadedmetadata', function (summary) {
